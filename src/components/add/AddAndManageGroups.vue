<template>
  <v-expansion-panel popout>
    <v-expansion-panel-content v-model="isBirthdayFormOpen">
      <div slot="header">
        {{ addPersonLabel }}
      </div>
      <ab-add-birth-date :isBirthdayFormOpen="isBirthdayFormOpen" />
    </v-expansion-panel-content>

    <v-expansion-panel-content v-model="isGroupFormOpen">
      <div slot="header">
        Manage groups
      </div>
      <div class="manage-groups">
        <ab-manage-groups :isGroupFormOpen="isGroupFormOpen" />
      </div>
    </v-expansion-panel-content>
  </v-expansion-panel>
</template>
